    ...
    'Slider': {
        [RUS]: {
            slidersText: [
                ...
                {
                    title: 'Бензин',
                    description: 'Полный бак на любой заправке города за наш счет'
                },
                {
                    title: 'Обслуживание',
        ...
        [ENG]: {
            slidersText: [
                ...
                {
                    title: 'Insurance',
                    description: 'Full car insurance'
                },
                {
                    title: 'Gasoline',
                    description: 'A full tank at any gas station in the city at our expense'
                },
                {
                    title: 'Service',
