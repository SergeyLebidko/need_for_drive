...
function OrderDetailsActionButton({type, setMode, showOrderConfirmModal}) {
    ...
    let handleClick = () => {
        ...
        if (type === EXECUTE_ACTION) showOrderConfirmModal();
    }
...
OrderDetailsActionButton.propTypes = {
    ...
    showOrderConfirmModal: PropTypes.func
}

export default createStoreConnectedComponent('OrderDetailsActionButton')(OrderDetailsActionButton);